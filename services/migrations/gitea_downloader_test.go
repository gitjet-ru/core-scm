...
func TestGiteaDownloadRepo(t *testing.T) {
	...
	assertMilestonesEqual(t, []*base.Milestone{
		{
			...
			Deadline: ptrTime(time.Unix(1599263999, 0)),
			Updated:  ptrTime(time.Unix(0, 0)),
			State:    "open",
		},
		{
			Title:       "V1",
			...
			Created:     time.Unix(0, 0),
			Updated:     ptrTime(time.Unix(0, 0)),
			Closed:      ptrTime(time.Unix(1598985406, 0)),
			State:       "closed",
		},
	}, milestones)
	...
	assertIssuesEqual(t, []*base.Issue{
		{
			...
			Closed: ptrTime(time.Date(2020, 9, 1, 15, 49, 34, 0, time.UTC)),
		},
		{
			Number:      2,
			Title:       "Spam",
			...
			Closed: ptrTime(time.Unix(1598969497, 0)),
		},
	}, issues)
	...
	assertPullRequestEqual(t, &base.PullRequest{
		...
		Closed:      ptrTime(time.Unix(1598982934, 0)),
		...
		Merged:         true,
		MergedTime:     ptrTime(time.Unix(1598982934, 0)),
