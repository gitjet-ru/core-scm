...
* BUGFIXES
  ...
  * Fix bug when reading DB max lifetime (#17682) (#17690)
...
* BUGFIXES
  ...
  * Recreate Tables should Recreate indexes on SQL backend (#16718) (#16739)
  * Keep attachments on tasklist update (#16750) (#16757)
* TESTING
  * Bump SQL backend versions (#15710)
...
* BUGFIXES
  ...
  * Recreate Tables should Recreate indexes on SQL backend (#16718) (#16740)
...
* BUGFIXES
  ...
  * Handle misencoding of login_source cfg in one SQL backend (#16268) (#16275)
...
* BUGFIXES
  ...
  * Print useful error if embedded DB is used in settings but not supported (#14476) (#14874)
...
* BUGFIXES
  ...
  * Set utf8mb4 as the default charset on SQL backend if CHARSET is unset (#12563)
...
* ENHANCEMENTS
  ...
  * Support use nvarchar for all varchar columns in SQL Server style databases (#12269)
...
* BUGFIXES
  ...
  * Prevent panic on empty HOST for a SQL backend (#11850) (#11856)
...
* ENHANCEMENTS
  ...
  * Increase maximum embedded DB variables count to 32766 (#11696) (#11783)
  ...
  * Default SQL backend port 0 to allow automatic detection by default (#11642) (#11673)
  ...
  * Set SQL backend rowtype to dynamic for new tables (#10833)
...
* MISC
  ...
  * Change default charset for SQL backend on install to utf8mb4 (#10989)
...
* BUGFIXES
  ...
  * Doctor fix xorm.Count nil on embedded DB error (#11741)
...
* BUGFIXES
  ...
  * Fix embedded DB concurrency problems by using BEGIN IMMEDIATE (#10368) (#10493)
...
* FEATURES
  ...
  * Expose db.SetMaxOpenConns and allow non SQL backend dbs to set conn pool params (#8528)
...
* BUGFIXES
  ...
  * Expose db.SetMaxOpenConns and allow non SQL backend dbs to set conn pool params (#8528) (#8618)
  ...
  * Fix dropTableColumns embedded DB implementation (#7710)
...
* BUGFIXES
  ...
  * Fix dropTableColumns embedded DB implementation (#7710) (#7765)
...
* FEATURES
  ...
  * Add command to convert a SQL database from utf8 to utf8mb4 (#7144)
...
* BUGFIXES
  ...
  * Fix possible invalid SQL connection error (#7051)
  ...
  * Fix v85.go (#6851)
  * Make dropTableColumns drop columns on embedded DB and constraints on all (#6849)
  * Fix double-generation of scratch token (#6832) (#6833)
  * When mirroring we should set the remote to mirror (#6824)
  * Fix the v78 migration "Drop is_bare" on SQL backend #6707 (#6823)
  ...
  * Drop is_bare IDX only when it exists for SQL backend and MariaDB (#6736)
...
* ENHANCEMENTS
  ...
  * Add support of utf8mb4 for SQL backend (#6992)
...
* TESTING
  ...
  * Add SQL backend migration tests (needs #6823) (#6852)
...
* BUILD
  * Update SQL backend driver to last working version 20180314172330-6a30f4e59a44 (#7306)
  * Alpine 3.10 (#7256)
...
* BUGFIXES
  * Fix possbile SQL backend invalid connnection error (#7051) (#7071)
...
* BUGFIXES
  ...
  * Fix v78 migration for SQL backend (#6823) (#6854)
  ...
  * Drop is_bare IDX only when it exists for SQL backend and MariaDB (#6736) (#6744)
...
* BREAKING
  ...
  * Change embedded DB DB path default to data directory (#6198)
...
* BUGFIXES
  ...
  * Fix migration 78 error SQL backend (#5791)
  ...
  * Upgrade go-sql-driver/SQL backend to fix invalid connection error (#5748)
  ...
  * Fix embedded DB deadlock when assigning to a PR (#5640)
  * Refactor issue indexer (#5363)
* TESTING
  * Run benchmark at tag to track performances (#6035)
  * Add test environment for SQL backend8 (#5234)
* BUILD
...
* BUGFIXES
  ...
  * Fix embedded DB deadlock when assigning to a PR (#5640) (#5642)
  ...
  * Synchronize SSH keys on login with LDAP + Fix embedded DB deadlock on ldap ssh key deletion (#5557)
  ...
  * Fixed heatmap not working in SQL backend (#5248)
  * Fixed wrong api request url for instances running in subfolders (#5247)
  * Fix compatibility heatmap with SQL backend 8 (#5232)
  * Fix data race on migrate repository (#5224)
  * Fix embedded DB and SQL backend lock (#5214)
  * Fix embedded DB lock (#5210)
  ...
  * Fix embedded DB lock (#5184 & #5176)
  * Fix showing pull request link when delete a branch (#5166)
  * Fix JSON result of empty array in heatmap data array (#5154)
  * Update build tags for embedded DB_unlock notify (#5144)
  * This commit will reduce join star, repo_topic, topic tables on repo search, so that fix extra columns problem on SQL backend (#5136)
  * Fix deadlock when embedded DB (#5118)
...
* ENHANCEMENTS
  ...
  * Update vendor/go-embedded DB (#5133 & #5162)
...
* BUGFIXES
  ...
  * Reduce join star, repo_topic, topic tables on repo search, to resolve extra columns problem on SQL backend (#5136) (#5229)
  * Fix data race on migrate repository (#5224) (#5230)
  * Add secret to all webhook's payload where it has been missing (#5208) (#5199)
  * Fix embedded DB and SQL backend lock (#5210) (#5223) (#5214) (#5218) (#5176) (#5179)
  ...
  * Fix column droping for SQL backend that need new transaction for that (#4440)
  ...
  * Dep upgrade SQL backend lib (#4161)
...
* BUGFIXES
  * Fix column droping for SQL backend that need new transaction for that (#4440) (#4484)
...
* BUGFIXES
  ...
  * Fix SQL backend bug on org (#3405)
...
* BUGFIXES
  ...
  * fixes 500 error on dashboard when using SQL backend (#2504)
...
* BUGFIXES
  ...
  * Backport: Fixes 500 error on dashboard when using SQL backend (#2504) (#2662)
  ...
  * Fix compiling without embedded DB and gcc (#2177)
  ...
  * vendor: update embedded DB to fix "database is locked" errors (#2116)
  ...
  * fix potential embedded DB lock (#1680)
  ...
  * fix migrate failed and org dashboard failed on SQL backend database (#1448)
  ...
  * Fix delete user failed on embedded DB (#1321)
...
* TESTING
  ...
  * remove embedded DB tag when integration test with SQL backend/postgres and recreate database when init integration test (#1693)
  * SQL backend, Postgres integration tests in drone (#1638)
...
* BUILD
  ...
  * Skip embedded DB integration in CI (#2058)
...
* DOCS
  ...
  * add SQL backend to app.ini db config comment (#1172)
  * Add SQL backend to issues template (#1171)
* MISC
  * Add badge and link to the Matrix room (#2348)
  * ignore coverage steps. (#2257)
  * Use embedded DB database as default for Docker image (#2182)
  ...
  * embedded DB has a query timeout. Hopefully fixes most 'database locked' errors (#1961)
  ...
  * fix potential lock when embedded DB (#1647)
...
* FEATURES
  ...
  * Enabled SQL backend support [#383](https://github.com/go-gitea/gitea/pull/383)
