...
// Default TLS cert uses negative serial number (see upstream issue #895).
...
require (
	...
	github.com/gitjet-ru/git-storage v0.0.0
...
replace github.com/gitjet-ru/git-storage => ../git-storage
