...
import (
	...
	"github.com/gitjet-ru/core-scm/modules/git/attribute"
	"github.com/gitjet-ru/core-scm/modules/git/pipeline"
...
func LFSLocks(ctx *context.Context) {
	...
	gitRepo, err := localgit.OpenRepository(ctx, tmpBasePath)
	if err != nil {
